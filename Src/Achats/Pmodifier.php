	...
	include'payement.php';
    	...
    	echo '<div id="contvert2">';
        	...
        	echo'<form action="payement.php" method="post">';
            	...
            	//echo'<input type="hidden" name="somme_orig" value="'.$somme.'">';
            	echo '<table cellpadding="3" class="w95">';
                	echo'<tr><td class="textinput"> Date </td>
                		     <td><input type="text" name="date_pay" value="'.date('Y-m-d').'" class="labinput"></td></tr>';
                    echo'<tr><td class="textinput"> Somme </td>
                             <td><input type="text" name="somme" value="'.$somme.'" class="labinput"></td></tr>';
                    echo'<tr><td class="textinput"> Agent </td>
                             <td><input type="text" name="somme" value="'.$agent.'" class="labinput"></td></tr>';
            	echo '</table>';
