	...
	echo '<div id="cform"><div id="cform2">
		...
		echo'<input type="hidden" name="mas" value="LA"/>';
				  echo '<table cellpadding="3" class="w95" >';
							...
							echo'	<tr><td class="textinput">Prénom</td>
										<td><input type="text" name="pre_cli" class="labinput"></td></tr>';
							echo'	<tr><td class="textinput">Téléphone</td>
									  <td><input type="text"  name="tel" class="labinput"></td></tr>';
							echo'	<tr><td class="textinput">Téléphone 2</td>
							      <td><input type="text"  name="tel2" class="labinput"></td></tr>';
							echo'	<tr><td class="textinput">Adresse</td>
										<td><input type="text" name="adresse_cli" class="labinput"></td></tr>';
				  echo '</table>';
