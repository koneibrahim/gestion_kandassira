<?php
	...
	echo '<div id="cform"><div id="cform2">
		  <div id="cheader" class="textcen"><h2 class="titrecform">Ajout nouvelle prestation</h2></div><br/><br/><br/>';
	echo'	<form action="liste.php" method="post">';
	echo'<input type="hidden" name="mas" value="A"/>';
	echo '<table cellpadding="3" class="w95" >';

	echo'	<tr><td class="textinput">Nom</td><td>
				<input type="text" name="nom_pres" class="labinput"></td></tr>';
	echo'	<tr><td class="textinput">Prix</td><td>
	   		<input type="text" name="prix" class="labinput"></td></tr>';
